...
class BookReservationTest extends TestCase
{
    ...
    {
        $book = Book::factory()->create(['author_id' => 123]);
    ...
    public function a_user_can_check_out_a_book_twice()
    {
        ...
        $this->assertEquals($user->id, Reservation::find(3)->first()->user_id);
        $this->assertEquals($book->id, Reservation::find(3)->first()->book_id);
        ...
        $this->assertNotNull(Reservation::find(3)->checked_in_at);
        $this->assertEquals(now(), Reservation::find(3)->checked_in_at);
    }

    /** @test */
    public function if_not_checked_out_at_exception_is_thrown()
    {
